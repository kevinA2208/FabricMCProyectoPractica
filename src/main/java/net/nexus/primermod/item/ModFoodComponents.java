...
public class ModFoodComponents {
    ...
    public static final FoodComponent FRIES_POTATO = new FoodComponent.Builder().hunger(6).saturationModifier(0.7f).build();
    public static final FoodComponent SODA_DRINK = new FoodComponent.Builder().hunger(4).saturationModifier(0.3f).build();
}
