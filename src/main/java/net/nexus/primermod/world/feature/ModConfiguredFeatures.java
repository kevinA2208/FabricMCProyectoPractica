...
public class ModConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> MYTHRIL_ORE =
            ConfiguredFeatures.register("mythril_ore", Feature.ORE,
                    new OreFeatureConfig(OVERWORLD_MYTHRIL_ORES, 17));

    //Configured feature de blood ore
    public static final List<OreFeatureConfig.Target> OVERWORLD_BLOOD_ORES = List.of(
            OreFeatureConfig.createTarget(OreConfiguredFeatures.STONE_ORE_REPLACEABLES,
                    ModBlocks.BLOOD_ORE.getDefaultState()),
            OreFeatureConfig.createTarget(OreConfiguredFeatures.DEEPSLATE_ORE_REPLACEABLES,
                    ModBlocks.DEEPSLATE_BLOOD_ORE.getDefaultState()));

    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> BLOOD_ORE =
            ConfiguredFeatures.register("blood_ore", Feature.ORE,
                    new OreFeatureConfig(OVERWORLD_BLOOD_ORES, 9));
